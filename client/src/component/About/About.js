      ...
      >
        {(props) => (
          <div className="bar-flex" style={props}>
            <div className="tag-bold-flex">{dataskill.name}</div>
            <Spring
              from={{ width: "0%" }}
              to={{ width: dataskill.progress + "%" }}
              delay={number * 200}
            >
              {(props) => <div className="bar-fill" style={props}></div>}
            </Spring>
            <span className="show-percentage-skill">
              <CountUp delay={number * 0.2 + 1} end={dataskill.progress} />%
            </span>
          </div>
        )}
      </Spring>
