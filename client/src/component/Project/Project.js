...
import devrforum from '../../img/devforum.PNG';
...
import workaround from '../../img/workaround.PNG';
...
import spartan from '../../img/spartan.PNG';
import ShopMe from '../../img/ShopMe.PNG';
    ...
    render() {
        const infoData = [
            
            {
                ...
                info:'This a developer forum were developer can create post, share opinions and interact with each other',
            ...
            },
            {
                ...
                info: 'This a store website, the admin can manage the website and see customer order',
                frontend: 'React +Redux',
            ...
            },
            {
                ...
                frontend: 'React +Redux',
                info: "This is a fitness website for people to calculate calories based on consumption and workout",
                backend: ' Nodejs + Express + MongoDB',
                desc: 'React + Redux + MongoDB + Nodejs',
                        ...
                        >
                            {props => (
                                <div className="aboutintro" >
                                    <h1 className='twoline' style={props}>PROJECT</h1>
                                </div>
                            )}
                        </Spring>
                ...
                <Spring
                    ...
                    {props => (
                        <div className="projectobject" style={props} >
                            <div className="imgdisplay" style={{ backgroundImage: "url(" + dataskill.img + ")" }}>
                            </div>
